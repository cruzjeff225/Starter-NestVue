      ...
      <form class="auth-form" @submit.prevent="handleRegister">
        ...
        <div class="field-group">
          ...
          <div class="password-strength">
            ...
            ></div>
            <span v-if="password.length > 0 && password.length < 6"  class="strength-text weak-text">Débil</span>
            <span v-if="password.length >= 6 && password.length < 10" class="strength-text medium-text">Aceptable</span>
            <span v-if="password.length >= 10"                        class="strength-text strong-text">Segura</span>
          </div>
        </div>
...
.strength-bar.weak   { background: linear-gradient(90deg, #ef4444 33%, #e2e8f0 33%); }
.strength-bar.medium { background: linear-gradient(90deg, #f59e0b 66%, #e2e8f0 66%); }
.strength-bar.strong { background: #22c55e; }

.strength-text { font-size: 0.72rem; font-weight: 500; }
.weak-text   { color: #ef4444; }
